...
const hotQuestion: {_id: string, title:string}[]  = [
  { _id: '1', title: "How do I use express as a custion server in NextJS?" },
  { _id: '2', title: "Is it only me or the font is bolder than necessary?" },
  { _id: '3', title: "Can I get the course for free?" },
  { _id: '4', title: "Redux Toolkit Not Updating State as Expecte" },
